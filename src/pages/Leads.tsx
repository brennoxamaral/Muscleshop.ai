            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-3">
              {leads.filter(l => l.status === column.id).map(lead => (
                ...
                >
                  ...
                  <button className="w-full flex items-center justify-center gap-2 bg-green-500/10 text-green-400 hover:bg-green-500/20 py-2 rounded-md text-sm font-medium transition-colors">
