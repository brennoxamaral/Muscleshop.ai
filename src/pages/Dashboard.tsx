...
const kpis = [
  { title: 'Faturamento Hoje', value: 'R$ 5.100,00', icon: DollarSign, trend: '+12%', isPositive: true },
  { title: 'Novos Leads', value: '42', icon: Users, trend: '+5%', isPositive: true },
  { title: 'Pedidos Realizados', value: '18', icon: ShoppingBag, trend: '-2%', isPositive: false },
  { title: 'Taxa de Conversão', value: '42.8%', icon: TrendingUp, trend: '+8%', isPositive: true },
];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass rounded-xl p-6 border border-white/5">
        <h3 className="text-lg font-semibold text-white mb-6">Evolução de Faturamento</h3>
